/******************************************************************************************
*  ESP32-Cam - Image Capture & WebPage Server
* 
*   This program is a demo of how to use the ESP32-Cam camera.
*   It can take a photo and send it to the Web.
* 
*   The demo sketch will do the following tasks:
*    1. Set the camera to JPEG output mode.
*    2. Create a web page (http://172.16.42.26/) ==> See the correct IP on Serial Monitor. It can be changed
*    3. if server.on ("/capture", HTTP_GET, serverCapture) ==> take photo and send to the Web.
*    4. Rotate the image (at webPage)
*  
*  Developed by Marcelo Rovai on 08Feb21
...
const char* ssid = "belalangsembah";  // Enter SSID here
const char* password = "ahayhayam";  //Enter Password here
...
void configInitCamera(){
  ...
  s->set_hmirror(s, 1);        // 0 = disable , 1 = enable  ===> MIRROR
  s->set_vflip(s, 1);          // 0 = disable , 1 = enable  ===> FLIP V
